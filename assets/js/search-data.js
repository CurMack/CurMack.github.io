...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "My publications by categories in reversed chronological order. Full list on Google Scholar.",
          section: "Navigation",
          handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-our-paper-human-x-has-been-accepted-by-iccv-2025-as-highlight-tada-tada-tada",
          title: 'Our paper Human-X has been accepted by ICCV 2025 as Highlight! :tada::tada::tada:',
          description: "",
          section: "News",},{id: "news-we-have-organized-iccv-2025-workshop-challenge-human-robot-scene-interaction-and-collaboration-raised-hands",
          title: 'We have organized ICCV 2025 Workshop Challenge “Human-Robot-Scene Interaction and Collaboration”! :raised_hands:',
          description: "",
